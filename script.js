...
function mostrarPalavras(palavras) {
    ...
    // ==========================================
    // AQUI ENTRA O TEXTO EXPLICATIVO (APENAS NA CATEGORIA DE LINGUAGEM DE RUA)
    // ==========================================
    const inputBusca = document.getElementById("busca");
    const termoPesquisado = inputBusca ? inputBusca.value : "";
    
    // Verifica se a listagem atual corresponde à categoria restrita
    if (palavras.length > 0 && palavras.some(item => item.categoria && normalizar(item.categoria) === "linguagem de rua")) {
